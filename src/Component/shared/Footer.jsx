...
export default function Footer() {
  return (
    <>
    <footer className="px-4 h-[200px] divide-y dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto  lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex items-center justify-center gap-0 space-x-3 lg:justify-start">
					<div className='flex'><img src={logo} className='place-self-center  w-28 h-28 ' alt="" /><span className=" self-center text-2xl font-semibold">E-Com</span></div>
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3 text-sm text-center dark:text-gray-400">© 1968 Company Co. All rights reserved.</div>
		</div>
	</div>
